...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            {!!Form::input('url','archivo',null,['class'=>'form-control','placeholder'=>'Ingrese el enlace de su Proyecto'])!!}
            @error('archivo')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        <div class="form-group">
            ...
            {!!Form::input('url','avance',null,['class'=>'form-control','placeholder'=>'Ingrese el enlace de su Proyecto'])!!}
            @error('avance')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
